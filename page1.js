function clock() {
  ...
  function settime() {
    ...
    timing[0].innerText =
      "set value:" + " " + invalue1.options[invalue1.selectedIndex].text;
    timing[1].innerText =
      "set value1:" + " " + invalue2.options[invalue2.selectedIndex].text;
    timing[2].innerText =
      "set value2:" + " " + invalue3.options[invalue3.selectedIndex].text;
    timing[3].innerText =
      "set value3:" + " " + invalue4.options[invalue4.selectedIndex].text;
  }
